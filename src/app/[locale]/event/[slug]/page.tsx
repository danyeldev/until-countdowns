...
import {
  ...
  siteUrl,
  todayUtc,
  truncate, localizedMetadata } from "@/lib/seo";
...
export async function generateStaticParams() {
  ...
  return englishParams(slugs.map((slug) => ({ slug })));
}
...
export async function generateMetadata({
  ...
  if (slug.startsWith("share-")) {
    ...
    return localizedMetadata({
      title: `${shared.title} — ${formatLongDate(shared.date, null, locale)} countdown`,
      description: `${shared.title} is on ${formatLongDate(shared.date, null, locale)}. A countdown someone made on Until.`,
