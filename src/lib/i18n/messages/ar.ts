...
export const ar: Messages = {
  ...
  seo: {
    ...
    event: {
      ...
      whenIsCoarse: "متى {title}؟ الموعد المتوقع {period}",
      countdownColon: "العد التنازلي حتى {title}: {when}",
      countdownDash: "{title} — العد التنازلي حتى {when}",
      countdownDashCoarse: "{title} — {when}",
      description: "موعد {title}{status} هو {date}. {days} عد تنازلي مباشر وإضافة إلى التقويم.",
      descriptionCoarse:
        "موعد {title} متوقع {period}، واليوم المحدد لم يُعلن بعد. العد يبدأ فور إعلانه، مع إضافة إلى التقويم.",
      ...
      sharedMetaDescription: "موعد {title} هو {date}. عد تنازلي أنشأه أحدهم على Until.",
    },
    ...
    series: {
      ...
      description: "موعد {title} هو {date}. {days} عد تنازلي مباشر، وتواريخ كل عام، وإضافة إلى التقويم.",
      descriptionCoarse:
  ...
  event: {
    answer: {
      ...
      past: {
        zero: "كان موعد {title} اليوم، {date}.",
        one: "كان موعد {title} قبل يوم واحد، في {date}.",
        two: "كان موعد {title} قبل يومين، في {date}.",
        few: "كان موعد {title} قبل {n} أيام، في {date}.",
        many: "كان موعد {title} قبل {n} يومًا، في {date}.",
        other: "كان موعد {title} قبل {n} يوم، في {date}.",
      } as PluralForms,
      cancelled: "كان موعد {title} مُقررًا في {date} ثم أُلغي.",
      coarse: "موعد {title} متوقع {period}. اليوم المحدد لم يُعلن بعد.",
      plain: "موعد {title} هو {date}.",
    },
