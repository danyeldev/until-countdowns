...
| Details | Desktop series and 390px dated event checked. Countdown, source/date context, year navigation and metadata preserved. Every licensed photo, ShareAlike included, is the credited backdrop; generated artwork appears only when an event has no photo. |
